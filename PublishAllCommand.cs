...
public class DotnetMakePackages 
{
    ...
    public  void Run ()
    {
        ...
        string publishDirectory = "E:\\Projects\\EroMangaManager\\publish";
        ...
        foreach(var platform in platforms)
        {
            ...
            Process.Start("dotnet" , $" build {winappcsproj} -c Release -p:Platform={platform} -p:RuntimeIdentifier={rids[platform]} -p:AppxBundle=Never /p:GenerateAppxPackageOnBuild=true /p:PackageCertificateKeyFile=\"DJDQfff_new.pfx\" /p:PackageCertificatePassword=512131415zcb").WaitForExit();
